 ...
 */
public class UpcomingFragment extends Fragment implements UpcomingAdapter.OnClickItemListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (moviesData == null || moviesData.isEmpty()){
            setEmptyLayout(R.drawable.ic_upcoming, getString(R.string.title_upcoming_greeting), getString(R.string.message_upcoming_greeting));
            refreshData();
        } else {
    ...
    void refreshData() {
        if (CheckInternetAvailability.isInternetAvailable(getActivity())){
            ((MainActivity) getActivity()).getPresenter().getUpcomingMovies();
        } else {
            hideRefreshing();
        }
    }
    ...
    public void setMoviesData(List<Movie> moviesData) {
        ...
        if (moviesData.isEmpty()) {
            ...
            UpcomingAdapter movieAdapter = new UpcomingAdapter(moviesData, this);
